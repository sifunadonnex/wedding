# Wedding
A basic [wedding website](https://feiwedsolo.now.sh/) I created for my cousin using the Bulma CSS framework, Particles.js, jQuery.countdown, Google Satisfy Font and FontAwesome icons.
